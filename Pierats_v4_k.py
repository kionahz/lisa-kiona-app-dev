...
from helpers_v2_k import update_text, turtle_with_speech_bubble, map_bg, click_m1_q1
...
# Define a function to open backpack
def open_backpack():
    print("Opening backpack")
    # Add the logic to switch to the backpack page here


# Quest Buttons and Button to open backpack
buttons = [
    {"label": "🏳️", "top": "77%", "left": "39%", "font-size": "3vw", "onclick": open_backpack},  # Button M1 Q1
]

# Print buttons to check if they are created properly
print(buttons)

'''
# Quest Buttons and Button to open backpack
buttons = [
    {"label": "🏳️", "top": "77%", "left": "39%", "font-size": "3vw", "onclick": lambda: st.switch_page("pages/open_backpack.py")},  # Button M1 Q1
