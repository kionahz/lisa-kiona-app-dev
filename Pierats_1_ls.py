...
with col1:
    ...
    def turtle_speechbubble(speech_turtle, blue_bg, speechbubble_img, turtle_character_image):  # calls variables
    ...
    turtle_speechbubble(speech_turtle, blue_bg, speechbubble_img, turtle_character_image)

# Add content to the second column
with col2:
    def map_q1(bg_image_map, buttons, backpack_icon_image):
    ...
    map_q1(bg_image_map, buttons, backpack_icon_image)
